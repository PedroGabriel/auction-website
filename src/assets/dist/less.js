  ...
  return (function e(t, n, r) {
  ...
  })(
    {
      ...
      2: [
        ...
        { '../less/default-options': 17, './add-default-options': 1, './index': 8, 'promise/polyfill': 107 }
      ],
      3: [
        function(require, module, exports) {
            ...
            return {
              ...
              getCSS: function(path, webInfo, modifyVars) {
                ...
                if (
                  ...
                  new Date(webInfo.lastModified).valueOf() === new Date(timestamp).valueOf() &&
            ...
            function errorHTML(e, rootHref) {
              ...
              var errorline = function(e, i, classname) {
                if (e.extract[i] !== undefined) {
                  errors.push(
                    template
                      .replace(/\{line\}/, (parseInt(e.line, 10) || 0) + (i - 1))
              ...
              if (e.line) {
                ...
                errorline(e, 2, '');
                content +=
                  'on line ' + e.line + ', column ' + (e.column + 1) + ':</p>' + '<ul>' + errors.join('') + '</ul>';
              }
 ...
 */
        ...
        function(require, module, exports) {
          ...
          colorFunctions = {
            ...
            luminance: function(color) {
              var luminance =
                (0.2126 * color.rgb[0]) / 255 + (0.7152 * color.rgb[1]) / 255 + (0.0722 * color.rgb[2]) / 255;
          ...
          functionRegistry.addMultiple({
            ...
            each: function(list, rs) {
              ...
              iterator.forEach(function(item) {
                ...
                if (indexName) {
                  newRules.push(
                    new Declaration(indexName, new Dimension(i), false, false, this.index, this.currentFileInfo)
                  );
                }
                if (keyName) {
                ...
                rules.push(
                  new Ruleset([new Selector([new Element('', '&')])], newRules, rs.strictImports, rs.visibilityInfo())
                );
              });
        ...
        function(require, module, exports) {
          ...
          var minMax = function(isMin, args) {
            ...
            for (i = 0; i < args.length; i++) {
              ...
              unitStatic =
                (unit !== '' && unitStatic === undefined) || (unit !== '' && order[0].unify().unit.toString() === '')
                  ? unit
                  : unitStatic;
            ...
            functionRegistry.add('svg-gradient', function(direction) {
              ...
              for (i = 0; i < stops.length; i += 1) {
                ...
                if (
                  ...
                  (!((i === 0 || i + 1 === stops.length) && position === undefined) && !(position instanceof Dimension))
                ) {
                  throwArgumentDescriptor();
                }
              ...
              returner +=
                '</' + gradientType + 'Gradient>' + '<rect ' + rectangleDimension + ' fill="url(#g)" /></svg>';

              returner = encodeURIComponent(returner);

              returner = 'data:image/svg+xml,' + returner;
              return new URL(
                new Quoted("'" + returner + "'", returner, false, this.index, this.currentFileInfo),
                this.index,
                this.currentFileInfo
              );
            });
          ...
          module.exports = function(environment) {
            ...
            ImportManager.prototype.push = function(
              ...
              if (importOptions.isPlugin) {
                ...
                promise = fileManager.loadFile(path, currentFileInfo.currentDirectory, context, environment, function(
                  err,
                  loadedFile
                ) {
                  if (err) {
              ...
              if (typeof extract[1] === 'string') {
                ...
                if (extract[1]) {
                  errorTxt +=
                    ...
                    stylize(
                      stylize(
                        stylize(extract[1].substr(this.column, 1), 'bold') + extract[1].slice(this.column + 1),
                        'red'
                      ),
                      'inverse'
                    );
          ...
          module.exports = function() {
            ...
            parserInput.restore = function(possibleErrorMessage) {
              if (
                ...
                (parserInput.i === furthest && possibleErrorMessage && !furthestPossibleErrorMessage)
              ) {
              ...
              parsers: (parsers = {
                ...
                entities: {
                  ...
                  keyword: function() {
                    var k =
                      parserInput.$char('%') ||
                      parserInput.$re(/^\[?(?:[\w-]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+\]?/);
                    if (k) {
                  ...
                  url: function() {
                    ...
                    return new tree.URL(
                      value.value != null || value instanceof tree.Variable || value instanceof tree.Property
                        ? value
                  ...
                  color: function() {
                    ...
                    if (
                      ...
                      (rgb = parserInput.$re(/^#([A-Fa-f0-9]{8}|[A-Fa-f0-9]{6}|[A-Fa-f0-9]{3,4})/))
                    ) {
                ...
                mixin: {
                  ...
                  definition: function() {
                    var name,
                      ...
                      variadic = false;
                    if (
                      (parserInput.currentChar() !== '.' && parserInput.currentChar() !== '#') ||
                      parserInput.peek(/^[^{]*\}/)
                    ) {
                      return;
                    }
                  ...
                  do {
                    ...
                    if (e) {
                      ...
                      if (parserInput.$char(')')) {
                        if (p && e) {
                          nodes.push(
                            new tree.Paren(new tree.Declaration(p, e, null, null, parserInput.i, fileInfo, true))
                          );
                        } else if (e) {
      ...
      45: [
        function(require, module, exports) {
          ...
          var pm,
            PluginManagerFactory = function(less, newFactory) {
              if (newFactory || !pm) {
      ...
      60: [
        function(require, module, exports) {
          ...
          Declaration.prototype.genCSS = function(context, output) {
            ...
            output.add(
              this.important + (this.inline || (context.lastRule && context.compress) ? '' : ';'),
              this._fileInfo,
              this._index
            );
          };
                ...
                if (params[i].variadic) {
                  ...
                  if (val) {
                    ...
                    throw {
                      type: 'Runtime',
                      message:
                        'wrong number of arguments for ' + this.name + ' (' + argsLength + ' for ' + this.arity + ')'
                    };
                  }
     ...
     and *any* other value for a != b (e.g. undefined, NaN, -2 etc.) */
            ...
            doExtendChaining: function(extendsList, extendsListTarget, iterationCount) {
              ...
              if (extendsToAdd.length) {
                ...
                return extendsToAdd.concat(
                  extendVisitor.doExtendChaining(extendsToAdd, extendsListTarget, iterationCount + 1)
                );
              } else {
                return extendsToAdd;
              }
              ...
              for (matchIndex = 0; matchIndex < matches.length; matchIndex++) {
                ...
                if (match.pathIndex > currentSelectorPathIndex && currentSelectorPathElementIndex > 0) {
                  path[path.length - 1].elements = path[path.length - 1].elements.concat(
                    selectorPath[currentSelectorPathIndex].elements.slice(currentSelectorPathElementIndex)
                  );
                  currentSelectorPathElementIndex = 0;
      ...
      107: [
        ...
        { './lib/core.js': 104, './lib/es6-extensions.js': 105, './polyfill-done.js': 106, asap: 98 }
      ]
    },
    {},
    [2]
