  ...
  })(
    {
      ...
      2: [
        function(a, b, c) {
          ...
          if (window.less) for (key in window.less) window.less.hasOwnProperty(key) && (e[key] = window.less[key]);
          a('./add-default-options')(window, e),
            (e.plugins = e.plugins || []),
            window.LESS_PLUGINS && (e.plugins = e.plugins.concat(window.LESS_PLUGINS));
          ...
          b.exports = function(a, b, c) {
            ...
            function j(a, d) {
              var e = '{line} {content}',
                ...
                g = [],
                h =
                  (a.type || 'Syntax') + 'Error: ' + (a.message || 'There is an error in your .less file') + ' in ' + f,
                i = function(a, b, c) {
                  void 0 !== a.extract[b] &&
                    g.push(
                      e
          ...
          b.exports = function(b, c) {
            ...
            return (
              ...
              (f.prototype.doXHR = function(a, d, e, f) {
                ...
                'function' == typeof h.overrideMimeType && h.overrideMimeType('text/css'),
                  c.debug("XHR: Getting '" + a + "'"),
                  h.open('GET', a, i),
                  h.setRequestHeader('Accept', d || 'text/x-less, text/css; q=0.9, */*; q=0.5'),
                  h.send(null),
                  b.isFileProtocol && !b.fileAsync
                    ? 0 === h.status || (h.status >= 200 && h.status < 300)
                      ? e(h.responseText)
                      : f(h.status, a)
                    : i
              ...
              (f.prototype.loadFile = function(a, b, c, d) {
                b && !this.isPathAbsolute(a) && (a = b + a),
                  (a = c.ext ? this.tryAppendExtension(a, c.ext) : a),
                  (c = c || {});
                ...
                return new Promise(function(a, b) {
                  if (c.useFileCache && e[g])
                    try {
                      var d = e[g];
                      return a({ contents: d, filename: g, webInfo: { lastModified: new Date() } });
                    } catch (f) {
              ...
              function i(c) {
                ...
                q.remove(f),
                  ...
                  m.render(d, j, function(c, e) {
                    c
                      ? ((c.href = f), b(c))
                      : (r.setCSS(a.href, h.lastModified, j.modifyVars, e.css), b(null, e.css, d, a, h, f));
                  });
              }
              var j = f(c);
              d(j, a),
            ...
            return (
              ...
              (m.registerStylesheetsImmediately = function() {
                ...
                for (var b = 0; b < a.length; b++)
                  ('stylesheet/less' === a[b].rel || (a[b].rel.match(/stylesheet/) && a[b].type.match(s))) &&
                    m.sheets.push(a[b]);
              }),
                  ...
                  new Promise(function(d, f) {
                    ...
                    (g = i = new Date()),
                      ...
                      0 === l
                        ? ((i = new Date()),
                          (k = i - g),
                          m.logger.info('Less has finished and no sheets were loaded.'),
                          d({ startTime: g, endTime: i, totalMilliseconds: k, sheets: m.sheets.length }))
                        : j(
                            function(a, c, h, j, n) {
                              return a
                                ? (q.add(a, a.href || j.href), void f(a))
                                : (m.logger.info(
                                    n.local
                                      ? 'Loading ' + j.href + ' from cache.'
                                      : 'Rendered ' + j.href + ' successfully.'
                                  ),
                                  e.createCSS(b.document, c, j),
                                  m.logger.info('CSS for ' + j.href + ' generated in ' + (new Date() - i) + 'ms'),
                                  l--,
                                  0 === l &&
                                    ((k = new Date() - g),
                                    m.logger.info('Less has finished. CSS generated in ' + k + 'ms'),
                                    d({ startTime: g, endTime: i, totalMilliseconds: k, sheets: m.sheets.length })),
                                  void (i = new Date()));
                            },
                            a,
      ...
      12: [
        function(a, b, c) {
          b.exports = {
            Math: { ALWAYS: 0, PARENS_DIVISION: 1, PARENS: 2, STRICT_LEGACY: 3 },
      ...
      13: [
        function(a, b, c) {
          ...
          f.Parse = function(a) {
            h(a, this, i), 'string' == typeof this.paths && (this.paths = [this.paths]);
          };
          var j = [
            'paths',
            'compress',
          ...
          (f.Eval = function(a, b) {
            ...
            (f.Eval.prototype.isMathOn = function(a) {
              return (
                !!this.mathOn &&
                (!!('/' !== a || this.math === g.Math.ALWAYS || (this.parensStack && this.parensStack.length)) &&
                  (!(this.math > g.Math.PARENS_DIVISION) || (this.parensStack && this.parensStack.length)))
              );
            }),
            (f.Eval.prototype.pathRequiresRewrite = function(a) {
              var b = this.rewriteUrls === g.RewriteUrls.LOCAL ? e : d;
              return b(a);
            }),
            (f.Eval.prototype.rewritePath = function(a, b) {
              var c;
              return (b = b || ''), (c = this.normalizePath(b + a)), e(a) && d(b) && e(c) === !1 && (c = './' + c), c;
            }),
          ...
          (f.prototype.evalPlugin = function(a, b, c, f, g) {
            ...
            if (m && (j = l.get(m))) {
              ...
              try {
                ...
                return (p.message = p.message || 'Error during @plugin call'), new e(p, c, m);
              }
              return j;
            }
            ...
            try {
              (h = new Function('module', 'require', 'registerPlugin', 'functions', 'tree', 'less', 'fileInfo', a)),
                h(k, this.require(m), q, i, this.less.tree, this.less, g);
            } catch (p) {
              return new e(p, c, m);
            }
            ...
            if (
              ((j.imports = c),
              (j.filename = m),
              (!j.minVersion || this.compareVersion('3.0.0', j.minVersion) < 0) && (n = this.trySetOptions(j, m, o, f)))
            )
              return n;
            if (
            ...
            (f.prototype.trySetOptions = function(a, b, c, d) {
              if (d && !a.setOptions)
                return new e({
                  message: 'Options have been provided but the plugin ' + c + ' does not support any options.'
                });
              try {
            ...
            (f.prototype.validatePlugin = function(a, b, c) {
              return a
                ? ('function' == typeof a && (a = new a()),
                  a.minVersion && this.compareVersion(a.minVersion, this.less.version) < 0
                    ? new e({ message: 'Plugin ' + c + ' requires version ' + this.versionToString(a.minVersion) })
                    : a)
                : null;
            }),
            (f.prototype.compareVersion = function(a, b) {
              'string' == typeof a && ((a = a.match(/^(\d+)\.?(\d+)?\.?(\d+)?/)), a.shift());
              for (var c = 0; c < a.length; c++) if (a[c] !== b[c]) return parseInt(a[c]) > parseInt(b[c]) ? -1 : 1;
              return 0;
            }),
      ...
      23: [
        function(a, b, c) {
          ...
          function e(a, b) {
            ...
            if (c) return (c.value = a.value && /^(rgb|hsl)/.test(a.value) ? a.value : 'rgb'), c;
          }
          function f(a) {
          ...
          (h = {
            ...
            rgba: function(a, b, c, d) {
              try {
                if (a instanceof j) return (d = b ? f(b) : a.alpha), new j(a.rgb, d, 'rgba');
            ...
            hsla: function(a, b, c, e) {
              function g(a) {
                return (
                  (a = a < 0 ? a + 1 : a > 1 ? a - 1 : a),
                  6 * a < 1 ? h + (i - h) * a * 6 : 2 * a < 1 ? i : 3 * a < 2 ? h + (i - h) * (2 / 3 - a) * 6 : h
                );
              }
              try {
            ...
            fade: function(a, b) {
              var c = a.toHSL();
              return (c.a = b.value / 100), (c.a = d(c.a)), e(a, c);
            },
            spin: function(a, b) {
              var c = a.toHSL(),
                d = (c.h + b.value) % 360;
            ...
            color: function(a) {
              if (a instanceof k && /^#([A-Fa-f0-9]{8}|[A-Fa-f0-9]{6}|[A-Fa-f0-9]{3,4})$/i.test(a.value)) {
                var b = a.value.slice(1);
                return new j(b, void 0, '#' + b);
              }
              if (a instanceof j || (a = j.fromKeyword(a.value))) return (a.value = void 0), a;
              throw { type: 'Argument', message: 'argument must be a color keyword or 3|4|6|8 digit hex e.g. #FFF' };
            },
            tint: function(a, b) {
        ...
        function(a, b, c) {
          b.exports = function(b) {
            ...
            f.add('data-uri', function(a, f) {
              ...
              if (!s.contents)
                return h.warn('Skipped data-uri embedding of ' + j + ' because file not found'), g(this, f || a);
              var t = s.contents;
              ...
              return u.length >= v && this.context.ieCompat !== !1
                ? (h.warn(
                  ...
                  g(this, f || a))
                : new d(
                    new c('"' + u + '"', u, !1, this.index, this.currentFileInfo),
                    this.index,
        ...
        function(a, b, c) {
          ...
          i.addMultiple({
            ...
            extract: function(a, b) {
              return (b = b.value - 1), j(a)[b];
            },
            length: function(a) {
              return new d(j(a).length);
            },
            each: function(a, b) {
              var c,
                i,
              ...
              return (
                ...
                i.forEach(function(a) {
                  ...
                  var i, o;
                  a instanceof e
                    ? ((i = 'string' == typeof a.name ? a.name : a.name[0].value), (o = a.value))
                    : ((i = new d(j)), (o = a)),
                    (c = b.rules.slice(0)),
                    l && c.push(new e(l, o, !1, !1, this.index, this.currentFileInfo)),
                    n && c.push(new e(n, new d(j), !1, !1, this.index, this.currentFileInfo)),
                    m && c.push(new e(m, i, !1, !1, this.index, this.currentFileInfo)),
                    k.push(new f([new g([new h('', '&')])], c, b.strictImports, b.visibilityInfo()));
                }),
                new f([new g([new h('', '&')])], k, b.strictImports, b.visibilityInfo()).eval(this.context)
              );
            }
          });
        },
        ...
        function(a, b, c) {
          b.exports = function(b) {
            ...
            h.add('svg-gradient', function(a) {
              ...
              for (
                j = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1 1"><' + p + 'Gradient id="g" ' + i + '>',
                  k = 0;
                k < h.length;
                k += 1
              )
                h[k] instanceof e ? ((l = h[k].value[0]), (m = h[k].value[1])) : ((l = h[k]), (m = void 0)),
                  ...
                  (j +=
                    ...
                    '/>');
              return (
                (j += '</' + p + 'Gradient><rect ' + q + ' fill="url(#g)" /></svg>'),
              ...
              (b.prototype.push = function(b, c, i, j, k) {
                ...
                var n = function(a, c, d) {
                    ...
                    j.optional && a
                      ? (k(null, { rules: [] }, !1, null),
                        h.info(
                          'The file ' + d + ' was skipped because it was not found and the import was marked optional.'
                        ))
                      : (l.files[d] || j.inline || (l.files[d] = { root: c, options: j }),
                        a && !l.error && (l.error = a),
                        k(a, c, e, d));
                  },
                  o = {
                ...
                var q,
                  r = function(a) {
                    ...
                    (o.currentDirectory = p.getPath(c)),
                      o.rewriteUrls &&
                        ((o.rootpath = p.join(l.context.rootpath || '', p.pathDiff(o.currentDirectory, o.entryPath))),
                        !p.isPathAbsolute(o.rootpath) &&
                          p.alwaysMakePathsAbsolute() &&
                          (o.rootpath = p.join(o.entryPath, o.rootpath))),
                      (o.filename = c);
                    var h = new d.Parse(l.context);
                    (h.processImports = !1),
                      (l.contents[c] = g),
                      (i.reference || j.reference) && (o.reference = !0),
                      j.isPlugin
                        ? ((b = m.evalPlugin(g, h, l, j.pluginArgs, o)), b instanceof f ? n(b, null, c) : n(null, b, c))
                        : j.inline
                        ? n(null, g, c)
                        : !l.files[c] || l.files[c].options.multiple || j.multiple
                        ? new e(h, l, o).parse(g, function(a, b) {
                            n(a, b, c);
                          })
                        : n(null, l.files[c].root, c);
                  },
                  s = g.clone(this.context);
                c && (s.ext = j.isPlugin ? '.js' : '.less'),
                  (q = j.isPlugin
                    ? m.loadPlugin(b, i.currentDirectory, s, a, p)
                    : p.loadFile(b, i.currentDirectory, s, a, function(a, b) {
                        a ? n(a) : r(b);
                      })),
                  q && q.then(r, n);
              }),
          ...
          b.exports = function(b, c) {
            ...
            for (var m in j.tree)
              if (((i = j.tree[m]), 'function' == typeof i)) l[m.toLowerCase()] = k(i);
                ...
                for (var n in i) l[m][n.toLowerCase()] = k(i[n]);
              }
            return l;
          };
        },
        ...
        function(a, b, c) {
            ...
            e = (b.exports = function(a, b, c) {
              ...
              if (((this.message = a.message), (this.stack = a.stack), b && e)) {
                ...
                (this.callLine = j + 1),
                  ...
                  (this.extract = [k[this.line - 2], k[this.line - 1], k[this.line]]);
              }
            });
          ...
          (e.prototype.constructor = e),
            (e.prototype.toString = function(a) {
              ...
              if (null !== this.line) {
                if (
                  ('string' == typeof c[0] && d.push(e(this.line - 1 + ' ' + c[0], 'grey')), 'string' == typeof c[1])
                ) {
                  var g = this.line + ' ';
                  c[1] &&
                    (g +=
                      c[1].slice(0, this.column) +
                      e(e(e(c[1].substr(this.column, 1), 'bold') + c[1].slice(this.column + 1), 'red'), 'inverse')),
                    d.push(g);
                }
                'string' == typeof c[2] && d.push(e(this.line + 1 + ' ' + c[2], 'grey')),
                  (d = d.join('\n') + e('', 'reset') + '\n');
              }
              return (
                (b += e(this.type + 'Error: ' + this.message, 'red')),
                this.filename && (b += e(' in ', 'red') + this.filename),
                this.line && (b += e(' on line ' + this.line + ', column ' + (this.column + 1) + ':', 'grey')),
                (b += '\n' + d),
                this.callLine &&
                  ((b += e('from ', 'red') + (this.filename || '') + '/n'),
                  (b += e(this.callLine, 'grey') + ' ' + this.callExtract + '/n')),
                b
              );
            });
        },
        ...
        function(a, b, c) {
          ...
          b.exports = function(b, c, j) {
            var k = function(b, c, l) {
              if (
                ('function' == typeof c
                  ? ((l = c), (c = i.copyOptions(this.options, {})))
                  : (c = i.copyOptions(this.options, c || {})),
                !l)
              ) {
                  ...
                  c.plugins.forEach(function(a) {
                    ...
                    if (a.fileContent) {
                      if (
                        ...
                        (b = p.Loader.evalPlugin(c, n, s, a.options, a.filename)),
                        b instanceof h)
                      )
                        return l(b);
                    } else p.addPlugin(a);
                  ...
                  if (0 === h && d(r)) (f = b.substr(n, o - n)), j.push(f ? f : ' '), (f = j), a(o - m), (p = !1);
                    ...
                    switch (r) {
                      ...
                      case '"':
                        (e = k.$quoted(o)),
                          e
                            ? (j.push(b.substr(n, o - n), e), (o += e[1].length - 1), (n = o + 1))
                            : (a(o - m), (f = r), (p = !1));
                        break;
                      case '{':
                        i.push('}'), h++;
      ...
      44: [
        function(a, b, c) {
          var d = a('../less-error'),
            ...
            j = function k(a, b, c) {
              function j(a, e) {
                throw new d({ index: q.i, filename: c.filename, type: e || 'Syntax', message: a }, b);
              }
              function l(a, b) {
                var c = a instanceof Function ? a.call(p) : q.$re(a);
                return c
                  ? c
                  : void j(
                      b ||
                        ('string' == typeof a
                          ? "expected '" + a + "' got '" + q.currentChar() + "'"
                          : 'unexpected token')
                    );
              }
              function m(a, b) {
                return q.$char(a) ? a : void j(b || "expected '" + a + "' got '" + q.currentChar() + "'");
              }
              function n(a) {
                var b = c.filename;
                return { lineNumber: h.getLocation(a, q.getInput()).line + 1, fileName: b };
              }
              function o(a, c, e, f, g) {
                ...
                try {
                  ...
                  for (var k, l, m = 0; (k = c[m]); m++)
                    (l = j.i), (h = p[k]()), h ? ((h._index = l + e), (h._fileInfo = f), i.push(h)) : i.push(null);
                  var n = j.end();
                  n.isFinished ? g(null, i) : g(!0, null);
                } catch (o) {
                  throw new d({ index: o.index + e, message: o.message }, b, f.filename);
                }
              }
              var p,
                q = g();
              return {
                ...
                parse: function(g, h, j) {
                  var l,
                    ...
                    r = '';
                  if (
                    ((m = j && j.globalVars ? k.serializeVars(j.globalVars) + '\n' : ''),
                    (n = j && j.modifyVars ? '\n' + k.serializeVars(j.modifyVars) : ''),
                    a.pluginManager)
                  )
                    for (var s = a.pluginManager.getPreProcessors(), t = 0; t < s.length; t++)
                      g = s[t].process(g, { context: a, imports: b, fileInfo: c });
                  (m || (j && j.banner)) &&
                    ((r = (j && j.banner ? j.banner : '') + m),
                  ...
                  if (!v.isFinished) {
                    ...
                    w ||
                      ...
                      '}' === v.furthestChar
                        ? (w += ". Possibly missing opening '{'")
                        : ')' === v.furthestChar
                        ? (w += ". Possibly missing opening '('")
                        : v.furthestReachedEnd && (w += '. Possibly missing something')),
                      (p = new d({ type: 'Parse', message: w, index: v.furthest, filename: c.filename }, b));
                  }
                  var x = function(a) {
                    return (
                      (a = p || a || b.error), a ? (a instanceof d || (a = new d(a, b, c.filename)), h(a)) : h(null, l)
                    );
                  };
                ...
                parsers: (p = {
                  ...
                  entities: {
                    ...
                    quoted: function(a) {
                      ...
                      return (b = q.$quoted())
                        ? (q.forget(), new e.Quoted(b.charAt(0), b.substr(1, b.length - 2), f, d, c))
                        : void q.restore();
                    },
                    keyword: function() {
                      var a = q.$char('%') || q.$re(/^\[?(?:[\w-]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+\]?/);
                    ...
                    call: function() {
                      ...
                      if (!q.peek(/^url\(/i))
                        return (
                          ...
                          (a = q.$re(/^([\w-]+|%|progid:[\w\.]+)\(/))
                            ? ((a = a[1]),
                              (d = this.customFuncCall(a)),
                              d && ((b = d.parse()), b && d.stop)
                                ? (q.forget(), b)
                                : ((b = this.arguments(b)),
                                  q.$char(')')
                                    ? (q.forget(), new e.Call(a, b, f, c))
                                    : void q.restore("Could not parse call arguments or missing ')'")))
                            : void q.forget()
                        );
                    },
                    customFuncCall: function(a) {
                      ...
                      function c() {
                        return [l(p.condition, 'expected condition')];
                      }
                    ...
                    arguments: function(a) {
                      ...
                      for (q.save(); ; ) {
                        ...
                        q.$char(',') ||
                          ((q.$char(';') || b) &&
                            ((b = !0), (c = d.length < 1 ? d[0] : new e.Value(d)), f.push(c), (d = [])));
                      }
                    ...
                    assignment: function() {
                      ...
                      return (
                        q.save(),
                        (a = q.$re(/^\w+(?=\s?=)/i)) && q.$char('=') && (b = p.entity())
                          ? (q.forget(), new e.Assignment(a, b))
                          : void q.restore()
                      );
                    },
                    url: function() {
                      ...
                      return (
                        ...
                        q.$str('url(')
                          ? ((a =
                            ...
                            m(')'),
                            new e.URL(
                              null != a.value || a instanceof e.Variable || a instanceof e.Property
                                ? a
                                : new e.Anonymous(a, b),
                              b,
                              c
                    ...
                    variable: function() {
                      var a,
                        b,
                        d = q.i;
                      if ((q.save(), '@' === q.currentChar() && (b = q.$re(/^@@?[\w-]+/)))) {
                        if (((a = q.currentChar()), '(' === a || ('[' === a && !q.prevChar().match(/^\s/)))) {
                          var f = p.variableCall(b);
                          if (f) return q.forget(), f;
                        }
                        return q.forget(), new e.Variable(b, d, c);
                      }
                      q.restore();
                    },
                    variableCurly: function() {
                      var a,
                        b = q.i;
                      if ('@' === q.currentChar() && (a = q.$re(/^@\{([\w-]+)\}/)))
                        return new e.Variable('@' + a[1], b, c);
                    },
                    property: function() {
                      var a,
                        b = q.i;
                      if ('$' === q.currentChar() && (a = q.$re(/^\$[\w-]+/))) return new e.Property(a, b, c);
                    },
                    propertyCurly: function() {
                      var a,
                        b = q.i;
                      if ('$' === q.currentChar() && (a = q.$re(/^\$\{([\w-]+)\}/)))
                        return new e.Property('$' + a[1], b, c);
                    },
                    color: function() {
                      var a;
                      if ('#' === q.currentChar() && (a = q.$re(/^#([A-Fa-f0-9]{8}|[A-Fa-f0-9]{6}|[A-Fa-f0-9]{3,4})/)))
                        return new e.Color(a[1], void 0, a[0]);
                    },
                    ...
                    dimension: function() {
                      if (!q.peekNotNumeric()) {
                        var a = q.$re(/^([+-]?\d*\.?\d+)(%|[a-z_]+)?/i);
                        return a ? new e.Dimension(a[1], a[2]) : void 0;
                      }
                    },
                    unicodeDescriptor: function() {
                      var a;
                      if ((a = q.$re(/^U\+[0-9a-fA-F?]+(\-[0-9a-fA-F?]+)?/))) return new e.UnicodeDescriptor(a[0]);
                    },
                    javascript: function() {
                      var a,
                        b = q.i;
                      ...
                      return f
                        ? (a = q.$re(/^[^`]*`/))
                          ? (q.forget(), new e.JavaScript(a.substr(0, a.length - 1), Boolean(d), b, c))
                          : void q.restore('invalid javascript definition')
                        : void q.restore();
                    }
                  },
                  variable: function() {
                    var a;
                    if ('@' === q.currentChar() && (a = q.$re(/^(@[\w-]+)\s*:/))) return a[1];
                  },
                  variableCall: function(a) {
                    ...
                    if ((q.save(), h || ('@' === q.currentChar() && (h = q.$re(/^(@[\w-]+)(\(\s*\))?/))))) {
                      if (((b = this.mixin.ruleLookups()), !b && ((g && '()' !== q.$str('()')) || '()' !== h[2])))
                        return void q.restore("Missing '[...]' lookup in variable call");
                  ...
                  extend: function(a) {
                    ...
                    if (q.$str(a ? '&:extend(' : ':extend(')) {
                      do {
                        for (f = null, b = null; !(f = q.$re(/^(all)(?=\s*(\)|,))/)) && (d = this.element()); )
                          b ? b.push(d) : (b = [d]);
                        (f = f && f[1]),
                          b || j('Missing target selector for :extend().'),
                          (h = new e.Extend(new e.Selector(b), f, i, c)),
                          g ? g.push(h) : (g = [h]);
                      } while (q.$char(','));
                      return l(/^\)/), a && l(/^;/), g;
                    }
                  ...
                  mixin: {
                    call: function(a, b) {
                      var d,
                        ...
                        k = q.i;
                      if ('.' === i || '#' === i) {
                        if ((q.save(), (f = this.elements()))) {
                          if (
                            (q.$char('(') && ((g = this.args(!0).args), m(')'), (h = !0)),
                            b !== !1 && (d = this.ruleLookups()),
                            b === !0 && !d)
                          )
                            return void q.restore();
                          if (a && !d && !h) return void q.restore();
                          if ((!a && p.important() && (j = !0), a || p.end())) {
                            q.forget();
                            var l = new e.mixin.Call(f, g, k, c, !d && j);
                            return d ? new e.NamespaceValue(l, d, j) : l;
                          }
                        }
                        q.restore();
                      }
                    ...
                    args: function(a) {
                      ...
                      for (q.save(); ; ) {
                        if (a) h = p.detachedRuleset() || p.expression();
                          ...
                          if (((q.commentStore.length = 0), q.$str('...'))) {
                            (l.variadic = !0), q.$char(';') && !b && (b = !0), (b ? n : o).push({ variadic: !0 });
                            break;
                          }
                        ...
                        var s = null;
                        if (
                          (a ? h.value && 1 == h.value.length && (s = h.value[0]) : (s = h),
                          s && (s instanceof e.Variable || s instanceof e.Property))
                        )
                          if (q.$char(':')) {
                            if (
                              (m.length > 0 && (b && j('Cannot mix ; and , as delimiter types'), (c = !0)),
                              (g = p.detachedRuleset() || p.expression()),
                              !g)
                            ) {
                            ...
                            if (!a) {
                              (l.variadic = !0),
                                q.$char(';') && !b && (b = !0),
                                (b ? n : o).push({ name: h.name, variadic: !0 });
                              break;
                            }
                            i = !0;
                          } else a || ((d = f = s.name), (g = null));
                        g && m.push(g),
                          o.push({ name: f, value: g, expand: i }),
                          q.$char(',')
                            ? (r = !0)
                            : ((r = ';' === q.$char(';')),
                              (r || b) &&
                                (c && j('Cannot mix ; and , as delimiter types'),
                                (b = !0),
                                m.length > 1 && (g = new e.Value(m)),
                                n.push({ name: d, value: g, expand: i }),
                                (d = null),
                                (m = []),
                                (c = !1)));
                      }
                    ...
                    definition: function() {
                      ...
                      if (!(('.' !== q.currentChar() && '#' !== q.currentChar()) || q.peek(/^[^{]*\}/)))
                        if ((q.save(), (b = q.$re(/^([#.](?:[\w-]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+)\s*\(/)))) {
                          a = b[1];
                          var h = this.args(!1);
                          if (((f = h.args), (g = h.variadic), !q.$char(')')))
                            return void q.restore("Missing closing ')'");
                          if (
                            ((q.commentStore.length = 0),
                            q.$str('when') && (d = l(p.conditions, 'expected condition')),
                            (c = p.block()))
                          )
                            return q.forget(), new e.mixin.Definition(a, f, c, d, g);
                          q.restore();
                        } else q.forget();
                    },
                    ruleLookups: function() {
                      ...
                      if ('[' === q.currentChar()) {
                        for (;;) {
                          if ((q.save(), (b = null), (a = this.lookupValue()), !a && '' !== a)) {
                            q.restore();
                            break;
                          }
                          c.push(a), q.forget();
                    ...
                    lookupValue: function() {
                      if ((q.save(), !q.$char('['))) return void q.restore();
                      var a = q.$re(/^(?:[@$]{0,2})[_a-zA-Z0-9-]*/);
                      return q.$char(']') && (a || '' === a) ? (q.forget(), a) : void q.restore();
                    }
                  },
                  entity: function() {
                    var a = this.entities;
                  ...
                  ieAlpha: function() {
                    ...
                    if (q.$re(/^opacity=/i))
                      return (
                        (a = q.$re(/^\d+/)),
                        a ||
                          ((a = l(p.entities.variable, 'Could not parse alpha')), (a = '@{' + a.name.slice(1) + '}')),
                        m(')'),
                        new e.Quoted('', 'alpha(opacity=' + a + ')')
                      );
                  },
                  element: function() {
                    var a,
                    ...
                    if (
                      ...
                      (a =
                        q.$re(/^(?:\d+\.\d+|\d+)%/) ||
                        q.$re(/^(?:[.#]?|:*)(?:[\w-]|[^\x00-\x9f]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+/) ||
                        q.$char('*') ||
                        q.$char('&') ||
                        this.attribute() ||
                        q.$re(/^\([^&()@]+\)/) ||
                      ...
                      a ||
                        (q.save(),
                        q.$char('(')
                          ? (d = this.selector(!1)) && q.$char(')')
                            ? ((a = new e.Paren(d)), q.forget())
                            : q.restore("Missing closing ')'")
                          : q.forget()),
                      a)
                    )
                      return new e.Element(b, a, a instanceof e.Variable, f, c);
                  },
                  combinator: function() {
                    var a = q.currentChar();
                    if ('/' === a) {
                    ...
                    if ('>' === a || '+' === a || '~' === a || '|' === a || '^' === a) {
                      for (q.i++, '^' === a && '^' === q.currentChar() && ((a = '^^'), q.i++); q.isWhitespace(); )
                        q.i++;
                  ...
                  selector: function(a) {
                    ...
                    for (
                      a = a !== !1;
                      ((a && (d = this.extend())) || (a && (i = q.$str('when'))) || (g = this.element())) &&
                      (i
                        ? (k = l(this.conditions, 'expected condition'))
                        : k
                        ? j('CSS guard can only be used at the end of selector')
                        : d
                        ? (h = h ? h.concat(d) : d)
                        : (h && j('Extend can only be used at the end of selector'),
                          (f = q.currentChar()),
                          b ? b.push(g) : (b = [g]),
                          (g = null)),
                      '{' !== f && '}' !== f && ';' !== f && ',' !== f && ')' !== f);
                    ...
                    return b
                      ...
                      : void (h && j('Extend must be used to extend a selector, it cannot be used on its own'));
                  },
                  selectors: function() {
                    for (var a, b; ; ) {
                      ...
                      if (
                        (b ? b.push(a) : (b = [a]),
                        (q.commentStore.length = 0),
                        a.condition && b.length > 1 && j('Guards are only currently allowed on a single selector.'),
                        !q.$char(','))
                      )
                        break;
                      a.condition && j('Guards are only currently allowed on a single selector.'),
                        (q.commentStore.length = 0);
                    }
                    return b;
                  },
                  attribute: function() {
                    if (q.$char('[')) {
                      var a,
                        ...
                        d = this.entities;
                      return (
                        (a = d.variableCurly()) || (a = l(/^(?:[_A-Za-z0-9-\*]*\|)?(?:[_A-Za-z0-9-]|\\.)+/)),
                        (c = q.$re(/^[|~*$^]?=/)),
                        c && (b = d.quoted() || q.$re(/^[0-9]+%/) || q.$re(/^[\w-]+/) || d.variableCurly()),
                        m(']'),
                  ...
                  block: function() {
                    var a;
                    if (q.$char('{') && (a = this.primary()) && q.$char('}')) return a;
                  },
                  ...
                  detachedRuleset: function() {
                    ...
                    if (
                      (q.save(),
                      q.$re(/^[.#]\(/) && ((a = this.mixin.args(!1)), (b = a.args), (c = a.variadic), !q.$char(')')))
                    )
                      return void q.restore();
                    var d = this.blockRuleset();
                    return d
                      ? (q.forget(), b ? new e.mixin.Definition(null, b, d, null, c) : new e.DetachedRuleset(d))
                      : void q.restore();
                  },
                  ruleset: function() {
                    var b, c, d;
                    if (
                      (q.save(), a.dumpLineNumbers && (d = n(q.i)), (b = this.selectors()), b && (c = this.block()))
                    ) {
                      q.forget();
                      var f = new e.Ruleset(b, c, a.strictImports);
                      return a.dumpLineNumbers && (f.debugInfo = d), f;
                    }
                    q.restore();
                  },
                  declaration: function() {
                    ...
                    if ('.' !== j && '#' !== j && '&' !== j && ':' !== j)
                      if ((q.save(), (a = this.variable() || this.ruleProperty()))) {
                        if (
                          ((h = 'string' == typeof a),
                          h && ((b = this.detachedRuleset()), b && (d = !0)),
                          (q.commentStore.length = 0),
                          !b)
                        ) {
                          if (
                            ((g = !h && a.length > 1 && a.pop().value),
                            (b =
                              a[0].value && '--' === a[0].value.slice(0, 2)
                                ? this.permissiveValue()
                                : this.anonymousValue()))
                          )
                            return q.forget(), new e.Declaration(a, b, !1, g, i, c);
                  ...
                  permissiveValue: function(a) {
                    function b() {
                      var a = q.currentChar();
                      return 'string' == typeof i ? a === i : i.test(a);
                    }
                    var d,
                      f,
                      g,
                    ...
                    if (!b()) {
                      h = [];
                      do (f = this.comment()), f ? h.push(f) : ((f = this.entity()), f && h.push(f));
                      while (f);
                      if (((g = b()), h.length > 0)) {
                      ...
                      if ((q.save(), (h = q.$parseUntil(i)))) {
                        if (
                          ('string' == typeof h && j("Expected '" + h + "'", 'Parse'), 1 === h.length && ' ' === h[0])
                        )
                          return q.forget(), new e.Anonymous('', k);
                        var m;
                    ...
                    if (f) {
                      ...
                      if ((a = this.entities.quoted() || this.entities.url()))
                        return (
                          ...
                          q.$char(';') || ((q.i = d), j('missing semi-colon or unrecognised media features on import')),
                          (b = b && new e.Value(b)),
                  ...
                  importOption: function() {
                    var a = q.$re(/^(less|css|multiple|once|inline|reference|optional)/);
                    if (a) return a[1];
                  },
                  mediaFeature: function() {
                    ...
                    q.save();
                    do
                      (a = d.keyword() || d.variable() || d.mixinLookup()),
                        a
                          ? f.push(a)
                          : q.$char('(') &&
                            ((b = this.property()),
                            ...
                            q.$char(')')
                              ? b && a
                                ? f.push(new e.Paren(new e.Declaration(b, a, null, null, q.i, c, !0)))
                                : a
                                ? f.push(new e.Paren(a))
                                : j('badly formed media feature definition')
                  ...
                  mediaFeatures: function() {
                    ...
                    do
                      if ((a = this.mediaFeature())) {
                        if ((c.push(a), !q.$char(','))) break;
                      } else if (((a = b.variable() || b.mixinLookup()), a && (c.push(a), !q.$char(',')))) break;
                    while (a);
                  ...
                  media: function() {
                    ...
                    return (
                      ...
                      q.$str('@media')
                        ? ((b = this.mediaFeatures()),
                          (d = this.block()),
                          d || j('media definitions require block statements after any features'),
                          q.forget(),
                  ...
                  plugin: function() {
                    ...
                    if (g) {
                      if (
                        ((b = this.pluginArgs()),
                        (d = b ? { pluginArgs: b, isPlugin: !0 } : { isPlugin: !0 }),
                        (a = this.entities.quoted() || this.entities.url()))
                      )
                        return (
                          q.$char(';') || ((q.i = f), j('missing semi-colon on @plugin')),
                          new e.Import(a, null, d, f, c)
                        );
                      (q.i = f), j('malformed @plugin statement');
                    }
                  },
                  pluginArgs: function() {
                    if ((q.save(), !q.$char('('))) return q.restore(), null;
                    var a = q.$re(/^\s*([^\);]+)\)\s*/);
                    return a[1] ? (q.forget(), a[1].trim()) : (q.restore(), null);
                  },
                  atrule: function() {
                    var b,
                      d,
                    ...
                    if ('@' === q.currentChar()) {
                      ...
                      if ((q.save(), (b = q.$re(/^@[a-z-]+/)))) {
                        ...
                        return (
                          (q.commentStore.length = 0),
                          h
                            ? ((d = this.entity()), d || j('expected ' + b + ' identifier'))
                            : i
                            ? ((d = this.expression()), d || j('expected ' + b + ' expression'))
                            : k &&
                              ((d = this.permissiveValue(/^[{;]/)),
                              (m = '{' === q.currentChar()),
                              d
                                ? d.value || (d = null)
                                : m || ';' === q.currentChar() || j(b + ' rule is missing block or ending semi-colon')),
                          m && (f = this.blockRuleset()),
                          f || (!m && d && q.$char(';'))
                            ? (q.forget(), new e.AtRule(b, d, f, l, c, a.dumpLineNumbers ? n(l) : null, o))
                            : void q.restore('at-rule options not recognised')
                        );
                      }
                    }
                  },
                  value: function() {
                    var a,
                      b = [],
                      c = q.i;
                    do if (((a = this.expression()), a && (b.push(a), !q.$char(',')))) break;
                    while (a);
                    if (b.length > 0) return new e.Value(b, c);
                  },
                  important: function() {
                    if ('!' === q.currentChar()) return q.$re(/^! *important/);
                  },
                  sub: function() {
                    var a, b;
                    return (
                      ...
                      q.$char('(')
                        ? ((a = this.addition()),
                          a && q.$char(')')
                            ? (q.forget(), (b = new e.Expression([a])), (b.parens = !0), b)
                            : void q.restore("Expected ')'"))
                        : void q.restore()
                    );
                  },
                  multiplication: function() {
                    ...
                    if ((a = this.operand())) {
                      for (f = q.isWhitespace(-1); ; ) {
                        if (q.peek(/^\/[*\/]/)) break;
                        if ((q.save(), (c = q.$char('/') || q.$char('*') || q.$str('./')), !c)) {
                          q.forget();
                          break;
                        }
                        if (((b = this.operand()), !b)) {
                  ...
                  conditionAnd: function(a) {
                    function b() {
                      var b = h.negatedCondition(a) || h.parenthesisCondition(a);
                      return b || a ? b : h.atomicCondition(a);
                    }
                    function c() {
                      return q.$str('and');
                    }
                  ...
                  negatedCondition: function(a) {
                    if (q.$str('not')) {
                      var b = this.parenthesisCondition(a);
                      return b && (b.negate = !b.negate), b;
                    }
                  },
                  parenthesisCondition: function(a) {
                    function b(b) {
                      var c;
                      return q.save(), (c = b.condition(a)) && q.$char(')') ? (q.forget(), c) : void q.restore();
                    }
                    var c;
                    return (
                      q.save(),
                      q.$str('(')
                        ? (c = b(this))
                          ? (q.forget(), c)
                          : (c = this.atomicCondition(a))
                          ? q.$char(')')
                            ? (q.forget(), c)
                            : void q.restore("expected ')' got '" + q.currentChar() + "'")
                          : void q.restore()
                        : void q.restore()
                    );
                  },
                  atomicCondition: function(a) {
                    function b() {
                      return this.addition() || h.keyword() || h.quoted() || h.mixinLookup();
                    }
                    var c,
                      d,
                      f,
                    ...
                    if (((b = b.bind(this)), (c = b())))
                      return (
                        q.$char('>')
                          ...
                          : q.$char('<')
                          ? (g = q.$char('=') ? '<=' : '<')
                          : q.$char('=') && (g = q.$char('>') ? '=>' : q.$char('<') ? '=<' : '='),
                        g
                          ? ((d = b()), d ? (f = new e.Condition(g, c, d, i, !1)) : j('expected expression'))
                          : (f = new e.Condition('=', c, new e.Keyword('true'), i, !1)),
                        f
                      );
                  },
                  operand: function() {
                      ...
                      (a = this.comment()),
                        a
                          ...
                          : ((a = this.addition() || this.entity()),
                            a &&
                              (c.push(a),
                              q.peek(/^\/[\/*]/) || ((b = q.$char('/')), b && c.push(new e.Anonymous(b, d)))));
                    while (a);
                    if (c.length > 0) return new e.Expression(c);
                  },
                  property: function() {
                    var a = q.$re(/^(\*?-?[_a-zA-Z0-9-]+)\s*:/);
                    if (a) return a[1];
                  },
                  ruleProperty: function() {
                    ...
                    if (f.length > 1 && a(/^((?:\+_|\+)?)\s*:/)) {
                      for (q.forget(), '' === f[0] && (f.shift(), g.shift()), d = 0; d < f.length; d++)
                        (b = f[d]),
                          (f[d] =
                            '@' !== b.charAt(0) && '$' !== b.charAt(0)
                              ...
                              : new e.Property('$' + b.slice(2, -1), g[d], c));
                      return f;
                    }
                    q.restore();
                  }
          ...
          (e.prototype.addPlugins = function(a) {
            ...
            (e.prototype.addPlugin = function(a, b, c) {
              this.installedPlugins.push(a),
                ...
                a.install && a.install(this.less, this, c || this.less.functions.functionRegistry);
            }),
        ...
        function(a, b, c) {
          ...
          b.exports = function(b, c, f) {
            var g = function(b, f, h) {
              if (
                ('function' == typeof f
                  ? ((h = f), (f = e.copyOptions(this.options, {})))
                  : (f = e.copyOptions(this.options, f || {})),
                !h)
              ) {
                d || (d = 'undefined' == typeof Promise ? a('promise') : Promise);
                var i = this;
          ...
          b.exports = function(a, b) {
            ...
            if (b.pluginManager) {
              ...
              for (var m = 0; m < 2; m++)
                for (j.first(); (i = j.get()); )
                  i.isPreEvalVisitor
                    ? (0 !== m && l.indexOf(i) !== -1) || (l.push(i), i.run(a))
                    : (0 !== m && k.indexOf(i) !== -1) || (i.isPreVisitor ? k.unshift(i) : k.push(i));
            }
            c = a.eval(h);
          ...
          (e.prototype = new d()),
            ...
            (e.prototype.genCSS = function(a, b) {
              (this.nodeVisible = Boolean(this.value)),
                this.nodeVisible && b.add(this.value, this._fileInfo, this._index, this.mapLines);
            }),
            (b.exports = e);
        },
        { './node': 76 }
              ...
              if (((this.name = a), (this.value = b instanceof d ? b : b ? new g(b) : b), c)) {
                for (
                  Array.isArray(c)
                    ? (this.rules = c)
                    : ((this.rules = [c]),
                      (this.rules[0].selectors = new e([], null, null, f, h).createEmptySelectors())),
                    l = 0;
                  l < this.rules.length;
                  l++
                )
      ...
      54: [
        function(a, b, c) {
          var d = a('./node'),
            ...
            g = function(a, b, c, d) {
              (this.name = a), (this.args = b), (this.calc = 'calc' === a), (this._index = c), (this._fileInfo = d);
            };
          (g.prototype = new d()),
            ...
            (g.prototype.eval = function(a) {
              ...
              var h,
                i = new f(this.name, a, this.getIndex(), this.fileInfo());
              if (i.isValid()) {
                try {
                  h = i.call(c);
                } catch (j) {
                  throw {
                    type: j.type || 'Runtime',
                    message: 'error evaluating function `' + this.name + '`' + (j.message ? ': ' + j.message : ''),
                    index: this.getIndex(),
                ...
                if (null !== h && void 0 !== h)
                  return (
                    h instanceof d || (h = new e(h && h !== !0 ? h.toString() : null)),
              ...
              Array.isArray(a)
                ...
                ? ((this.rgb = []),
                  a.match(/.{2}/g).map(function(a, b) {
                    b < 3 ? d.rgb.push(parseInt(a, 16)) : (d.alpha = parseInt(a, 16) / 255);
                  }))
                : ((this.rgb = []),
                  a.split('').map(function(a, b) {
                    b < 3 ? d.rgb.push(parseInt(a + a, 16)) : (d.alpha = parseInt(a + a, 16) / 255);
                  })),
                (this.alpha = this.alpha || ('number' == typeof b ? b : 1)),
          ...
          (h.prototype = new f()),
            ...
            (h.prototype.toCSS = function(a, b) {
              ...
              switch (f) {
                ...
                case 'hsl':
                  (c = this.toHSL()),
                    (h = [this.fround(a, c.h), this.fround(a, 100 * c.s) + '%', this.fround(a, 100 * c.l) + '%'].concat(
                      h
                    ));
              }
        ...
        function(a, b, c) {
          ...
          var e = a('./node'),
            ...
            j = function(a, b, c, d, g, i, j, k) {
              (this.name = a),
                (this.value = b instanceof e ? b : new f([b ? new h(b) : null])),
                (this.important = c ? ' ' + c.trim() : ''),
                (this.merge = d),
                (this._index = g),
                (this._fileInfo = i),
                (this.inline = j || !1),
                (this.variable = void 0 !== k ? k : a.charAt && '@' === a.charAt(0)),
                (this.allowRoot = !0),
          ...
          (j.prototype = new e()),
            ...
            (j.prototype.eval = function(a) {
              var b,
                ...
                f = this.name,
                h = this.variable;
              'string' != typeof f && ((f = 1 === f.length && f[0] instanceof g ? f[0].value : d(a, f)), (h = !1)),
                'font' === f && a.math === i.ALWAYS && ((e = !0), (b = a.math), (a.math = i.PARENS_DIVISION));
              try {
                if (
                  (a.importantScope.push({}), (c = this.value.eval(a)), !this.variable && 'DetachedRuleset' === c.type)
                )
                  throw {
                ...
                return (
                  ...
                  new j(f, c, k, this.merge, this.getIndex(), this.fileInfo(), this.inline, h)
                );
              } catch (m) {
                throw ('number' != typeof m.index &&
                  ((m.index = this.getIndex()), (m.filename = this.fileInfo().filename)),
                m);
              } finally {
                e && (a.math = b);
              }
            ...
            (i.prototype.eval = function(a) {
              ...
              return (
                ...
                this.value.length > 1
                  ...
                  : 1 === this.value.length
                  ? (!this.value[0].parens || this.value[0].parensInOp || a.inCalc || (f = !0),
                    (b = this.value[0].eval(a)))
                  : (b = this),
                d && a.outOfParenthesis(),
                !this.parens || !this.parensInOp || c || f || b instanceof g || (b = new e(b)),
                b
              );
            }),
            (i.prototype.genCSS = function(a, b) {
              for (var c = 0; c < this.value.length; c++)
                this.value[c].genCSS(a, b), !this.noSpacing && c + 1 < this.value.length && b.add(' ');
            }),
          ...
          (l.prototype = new d()),
            ...
            (l.prototype.accept = function(a) {
              this.features && (this.features = a.visit(this.features)),
                ...
                this.options.isPlugin || this.options.inline || !this.root || (this.root = a.visit(this.root));
            }),
            ...
            (l.prototype.evalForImport = function(a) {
              ...
              return (
                ...
                new l(b.eval(a), this.features, this.options, this._index, this._fileInfo, this.visibilityInfo())
              );
            }),
            ...
            (l.prototype.doEval = function(a) {
              ...
              if (this.options.isPlugin) {
                if (this.root && this.root.eval)
                  try {
                    ...
                    throw ((f.message = 'Plugin error during evaluation'),
                    new k(f, this.root.imports, this.root.filename));
                  }
                return (
              ...
              if (this.options.inline) {
                var g = new i(
                  this.root,
                  0,
                  { filename: this.importedFilename, reference: this.path._fileInfo && this.path._fileInfo.reference },
                  !0,
                  !0
                );
          ...
          (h.prototype = new d()),
            ...
            (h.prototype.eval = function(a) {
              ...
              return 'number' !== c || isNaN(b)
                ? 'string' === c
                  ? new f('"' + b + '"', b, this.escaped, this._index)
          ...
          var d = a('./selector'),
            ...
            l = function(a, b, c, f, g, h, i) {
              (this.name = a || 'anonymous mixin'),
                (this.selectors = [new d([new e(null, a, !1, this._index, this._fileInfo)])]),
                (this.params = b),
                (this.condition = f),
                (this.variadic = g),
                (this.arity = b.length),
          ...
          (l.prototype = new f()),
            ...
            (l.prototype.evalParams = function(a, b, c, d) {
              ...
              if (
                ...
                (b = new j.Eval(b, [s].concat(b.frames))),
                c)
              )
                for (c = k.copyArray(c), u = c.length, m = 0; m < u; m++)
                  if (((l = c[m]), (p = l && l.name))) {
                    for (q = !1, n = 0; n < t.length; n++)
                      if (!d[n] && p === t[n].name) {
                        (d[n] = l.value.eval(a)), s.prependRule(new g(p, l.value.eval(a))), (q = !0);
                        break;
                      }
                    if (q) {
                      c.splice(m, 1), m--;
                    ...
                    throw {
                      type: 'Runtime',
                      message: 'Named argument for ' + this.name + ' ' + c[m].name + ' not found'
                    };
                  }
                      ...
                      if ((o = l && l.value)) o = Array.isArray(o) ? new h(new f('', o)) : o.eval(a);
                        ...
                        if (!t[m].value)
                          throw {
                            type: 'Runtime',
                            message:
                              'wrong number of arguments for ' + this.name + ' (' + u + ' for ' + this.arity + ')'
                          };
                        (o = t[m].value.eval(b)), s.resetCache();
                      }
                      s.prependRule(new g(p, o)), (d[m] = o);
                    }
                  if (t[m].variadic && c) for (n = r; n < u; n++) d[n] = c[n].value.eval(a);
                  r++;
                }
              return s;
            }),
            ...
            (l.prototype.evalCall = function(a, b, c) {
              ...
              return (
                m.prependRule(new g('@arguments', new i(h).eval(a))),
                (d = k.copyArray(this.rules)),
                (e = new f(null, d)),
                (e.originalRuleset = this),
                (e = e.eval(new j.Eval(a, [this, m].concat(l)))),
                c && (e = e.makeImportant()),
                e
              );
            }),
            (l.prototype.matchCondition = function(a, b) {
              return !(
                ...
                !this.condition.eval(
                  new j.Eval(
                    b,
                    [this.evalParams(b, new j.Eval(b, this.frames ? this.frames.concat(b.frames) : b.frames), a, [])]
                      .concat(this.frames || [])
                      .concat(b.frames)
                  )
                )
        ...
        function(a, b, c) {
          var d = a('./node'),
            ...
            h = function(a, b, c, d, e) {
              (this.value = a), (this.lookups = b), (this.important = c), (this._index = d), (this._fileInfo = e);
            };
          (h.prototype = new d()),
            ...
            (h.prototype.eval = function(a) {
              ...
              for (b = 0; b < this.lookups.length; b++) {
                if (((c = this.lookups[b]), Array.isArray(d) && (d = new f([new g()], d)), '' === c))
                  d = d.lastDeclaration();
                else if ('@' === c.charAt(0)) {
                  if (
                    ('@' === c.charAt(1) && (c = '@' + new e(c.substr(1)).eval(a).value),
                    d.variables && (d = d.variable(c)),
                    !d)
                  )
                    throw {
                      type: 'Name',
                      message: 'variable ' + c + ' not found',
                      filename: this.fileInfo().filename,
                      index: this.getIndex()
                    };
                } else {
                  if (
                    ...
                    throw {
                      type: 'Name',
                      message: 'property "' + c.substr(1) + '" not found',
                      filename: this.fileInfo().filename,
                      index: this.getIndex()
                    };
                  d = d[d.length - 1];
          ...
          (h.prototype = new d()),
            ...
            (h.prototype.eval = function(a) {
              ...
              if (a.isMathOn(this.op)) {
                if (
                  ((b = './' === this.op ? '/' : this.op),
                  c instanceof f && d instanceof e && (c = c.toColor()),
                  d instanceof f && c instanceof e && (d = d.toColor()),
                  !c.operate)
                ) {
                  if (c instanceof h && '/' === c.op && a.math === g.PARENS_DIVISION)
      ...
      80: [
        function(a, b, c) {
          ...
          (g.prototype = new d()),
            ...
            (g.prototype.genCSS = function(a, b) {
              this.escaped || b.add(this.quote, this.fileInfo(), this.getIndex()),
                b.add(this.value),
            ...
            (g.prototype.eval = function(a) {
              ...
              return (
                ...
                new g(this.quote + d + this.quote, d, this.escaped, this.getIndex(), this.fileInfo())
              );
            }),
        ...
        function(a, b, c) {
          ...
          (q.prototype = new d()),
            ...
            (q.prototype.eval = function(a) {
              ...
              if (this.selectors && (c = this.selectors.length)) {
                ...
                if (h) {
                  ...
                  this.parse.parseNode(k.join(','), ['selectors'], b[0].getIndex(), b[0].fileInfo(), function(a, c) {
              ...
              (s.originalRuleset = this),
                ...
                this.debugInfo && (s.debugInfo = this.debugInfo),
                i || (r.length = 0),
              ...
              u || (a.selectors = u = []),
                ...
                (s.root || s.allowImports || !s.strictImports) && s.evalImports(a);
              var v = s.rules;
              ...
              for (g = 0; (l = v[g]); g++)
                'MixinCall' === l.type
                  ? ((r = l.eval(a).filter(function(a) {
                      return !(a instanceof e && a.variable) || !s.variable(a.name);
                    })),
                    v.splice.apply(v, [g, 1].concat(r)),
                    (g += r.length - 1),
                    s.resetCache())
                  : 'VariableCall' === l.type &&
                    ((r = l.eval(a).rules.filter(function(a) {
              ...
              for (g = 0; (l = v[g]); g++)
                if (
                  ...
                  for (var j = 0; (o = l.rules[j]); j++)
                    o instanceof d &&
                      (o.copyVisibilityInfo(l.visibilityInfo()), (o instanceof e && o.variable) || v.splice(++g, 0, o));
                }
            ...
            (q.prototype.genCSS = function(a, b) {
              ...
              if (((j = i.concat(j)), !this.root)) {
                ...
                for (k = a.compress ? ',' : ',\n' + m, c = 0; c < s; c++)
                  if (((h = r[c]), (q = h.length)))
                    for (
                      c > 0 && b.add(k), a.firstSelector = !0, h[0].genCSS(a, b), a.firstSelector = !1, d = 1;
                      d < q;
                      d++
                    )
                      h[d].genCSS(a, b);
              ...
              for (c = 0; (f = j[c]); c++) {
                ...
                f.isRulesetLike(f) && (a.lastRule = !1),
                  f.genCSS ? f.genCSS(a, b) : f.value && b.add(f.value.toString()),
                  (a.lastRule = t),
                  !a.lastRule && f.isVisible() ? b.add(a.compress ? '' : '\n' + l) : (a.lastRule = !1);
              }
            ...
            (q.prototype.joinSelector = function(a, b, c) {
              ...
              function e(a, b) {
                var c, d;
                return (c = new j(null, a, b.isVariable, b._index, b._fileInfo)), (d = new i([c]));
              }
              function f(a, b, c, d) {
                var e, f, g;
                if (
                  ((e = []),
                  a.length > 0
                    ? ((e = p.copyArray(a)), (f = e.pop()), (g = d.createDerived(p.copyArray(f.elements))))
                    : (g = d.createDerived([])),
                  b.length > 0)
                ) {
                  var h = c.combinator,
                    i = b[0].elements[0];
                  h.emptyOrWhitespace && !i.combinator.emptyOrWhitespace && (h = i.combinator),
                    g.elements.push(new j(h, i.value, c.isVariable, c._index, c._fileInfo)),
              ...
              function l(a, b, c) {
                ...
                for (q = [], r = [[]], n = 0; (u = c.elements[n]); n++)
                  if ('&' !== u.value) {
                    ...
                    for (x = !0, s = [], k(q, r), o = 0; o < r.length; o++)
                      if (((t = r[o]), 0 === b.length))
                        t.length > 0 &&
                          t[0].elements.push(new j(u.combinator, '', u.isVariable, u._index, u._fileInfo)),
                          s.push(t);
                      else
                ...
                for (k(q, r), n = 0; n < r.length; n++)
                  (v = r[n].length),
                    v > 0 &&
                      (a.push(r[n]), (w = r[n][v - 1]), (r[n][v - 1] = w.createDerived(w.elements, c.extendList)));
                return x;
              }
              function m(a, b) {
        ...
        function(a, b, c) {
          ...
          (g.prototype = new d()),
            ...
            (g.prototype.getElements = function(a) {
              return a
                ? ('string' == typeof a &&
                    this.parse.parseNode(a, ['selector'], this._index, this._fileInfo, function(b, c) {
                      if (b)
                        throw new f(
                          { index: b.index, message: b.message },
                          this.parse.imports,
            ...
            (g.prototype.genCSS = function(a, b) {
              ...
              for (
                (a && a.firstSelector) ||
                  ...
                  b.add(' ', this.fileInfo(), this.getIndex()),
                  c = 0;
        ...
        function(a, b, c) {
          ...
          (f.prototype = new e()),
            ...
            (f.prototype.eval = function(a) {
              ...
              if (
                !this.isEvald &&
                ((b = this.fileInfo() && this.fileInfo().rootpath),
                'string' == typeof b && 'string' == typeof c.value && a.pathRequiresRewrite(c.value)
                  ? (c.quote || (b = d(b)), (c.value = a.rewritePath(c.value, b)))
      ...
      87: [
        function(a, b, c) {
          var d = a('./node'),
            ...
            h = a('../less-error'),
            i = function(a, b, c) {
              (this.variable = a), (this._index = b), (this._fileInfo = c), (this.allowRoot = !0);
            };
          (i.prototype = new d()),
            (i.prototype.type = 'VariableCall'),
            (i.prototype.eval = function(a) {
              var b,
                c = new e(this.variable, this.getIndex(), this.fileInfo()).eval(a),
          ...
          (f.prototype = new d()),
            ...
            (f.prototype.eval = function(a) {
              var b,
                c = this.name;
              if (
                (0 === c.indexOf('@@') && (c = '@' + new f(c.slice(1), this.getIndex(), this.fileInfo()).eval(a).value),
                this.evaluating)
              )
                throw {
                  type: 'Name',
          ...
          var d = a('./constants'),
            ...
            f = {
              ...
              copyOptions: function(a, b) {
                ...
                if (
                  (c.strictMath && (c.math = d.Math.STRICT_LEGACY),
                  c.relativeUrls && (c.rewriteUrls = d.RewriteUrls.ALL),
                      ...
                      g.length &&
                        ...
                        j.selfSelectors.forEach(function(a) {
                          ...
                          (h = n.extendSelector(g, i, a, j.isVisible())),
                            (l = new d.Extend(k.selector, k.option, 0, k.fileInfo(), b)),
                            (l.selfSelectors = h),
          ...
          (h.prototype = {
            ...
            processImportNode: function(a, b, c) {
              ...
              try {
                ...
                f.filename || ((f.index = a.getIndex()), (f.filename = a.fileInfo().filename)),
                  (a.css = !0),
                  (a.error = f);
              }
          ...
          (g.prototype = {
            ...
            checkValidNodes: function(a, b) {
              if (a)
                for (var c = 0; c < a.length; c++) {
                  var e = a[c];
                  if (b && e instanceof d.Declaration && !e.variable)
                    throw {
              ...
              if (a) {
                ...
                c.forEach(function(a) {
                  if (a.length > 0) {
                    ...
                    a.forEach(function(a) {
                      '+' === a.merge && c.length > 0 && e.push(new d.Expression((c = []))),
                        c.push(a.value),
                        (b.important = b.important || a.important);
                    }),
        ...
        function(a, b, c) {
          ...
          function f(a) {
            var b,
              ...
              g,
              h = a.length;
            (f = d(a)), (g = new l((3 * h) / 4 - f)), (c = f > 0 ? h - 4 : h);
            var i = 0;
            for (b = 0; b < c; b += 4)
              (e =
                (k[a.charCodeAt(b)] << 18) |
                (k[a.charCodeAt(b + 1)] << 12) |
                (k[a.charCodeAt(b + 2)] << 6) |
                k[a.charCodeAt(b + 3)]),
                (g[i++] = (e >> 16) & 255),
                (g[i++] = (e >> 8) & 255),
                (g[i++] = 255 & e);
            return (
              2 === f
                ? ((e = (k[a.charCodeAt(b)] << 2) | (k[a.charCodeAt(b + 1)] >> 4)), (g[i++] = 255 & e))
                : 1 === f &&
                  ((e = (k[a.charCodeAt(b)] << 10) | (k[a.charCodeAt(b + 1)] << 4) | (k[a.charCodeAt(b + 2)] >> 2)),
                  (g[i++] = (e >> 8) & 255),
                  (g[i++] = 255 & e)),
              g
            );
          ...
          function h(a, b, c) {
            for (var d, e = [], f = b; f < c; f += 3) (d = (a[f] << 16) + (a[f + 1] << 8) + a[f + 2]), e.push(g(d));
            return e.join('');
          }
          function i(a) {
            for (var b, c = a.length, d = c % 3, e = '', f = [], g = 16383, i = 0, k = c - d; i < k; i += g)
              f.push(h(a, i, i + g > k ? k : i + g));
            return (
              1 === d
                ? ((b = a[c - 1]), (e += j[b >> 2]), (e += j[(b << 4) & 63]), (e += '=='))
                : 2 === d &&
                  ((b = (a[c - 2] << 8) + a[c - 1]),
                  (e += j[b >> 10]),
                  (e += j[(b >> 4) & 63]),
          ...
          (c.byteLength = e), (c.toByteArray = f), (c.fromByteArray = i);
          for (
            var j = [],
              k = [],
      ...
      101: [
        function(a, b, c) {
          ...
          function e(a) {
            if (a > Z) throw new RangeError('Invalid typed array length');
            var b = new Uint8Array(a);
            return (b.__proto__ = f.prototype), b;
          }
          function f(a, b, c) {
            if ('number' == typeof a) {
              if ('string' == typeof b)
          ...
          function g(a, b, c) {
            ...
            return U(a) ? m(a, b, c) : 'string' == typeof a ? k(a, b) : n(a);
          }
          function h(a) {
          ...
          function k(a, b) {
            if ((('string' == typeof b && '' !== b) || (b = 'utf8'), !f.isEncoding(b)))
          ...
          function l(a) {
            for (var b = a.length < 0 ? 0 : 0 | o(a.length), c = e(b), d = 0; d < b; d += 1) c[d] = 255 & a[d];
            return c;
          }
          function m(a, b, c) {
          ...
          function n(a) {
            ...
            if (a) {
              if (V(a) || 'length' in a) return 'number' != typeof a.length || W(a.length) ? e(0) : l(a);
              if ('Buffer' === a.type && Array.isArray(a.data)) return l(a.data);
            }
          ...
          function o(a) {
            if (a >= Z)
              throw new RangeError(
                'Attempt to allocate Buffer larger than maximum size: 0x' + Z.toString(16) + ' bytes'
              );
            return 0 | a;
          }
          function p(a) {
          ...
          function q(a, b) {
            if (f.isBuffer(a)) return a.length;
            if (V(a) || U(a)) return a.byteLength;
            'string' != typeof a && (a = '' + a);
            var c = a.length;
            if (0 === c) return 0;
            for (var d = !1; ; )
          ...
          function t(a, b, c, d, e) {
            ...
            if (('string' == typeof b && (b = f.from(b, d)), f.isBuffer(b)))
              return 0 === b.length ? -1 : u(a, b, c, d, e);
            if ('number' == typeof b)
              return (
                (b = 255 & b),
          ...
          function u(a, b, c, d, e) {
            ...
            if (
              void 0 !== d &&
              ((d = String(d).toLowerCase()), 'ucs2' === d || 'ucs-2' === d || 'utf16le' === d || 'utf-16le' === d)
            ) {
          ...
          function B(a, b, c) {
            return X.fromByteArray(0 === b && c === a.length ? a : a.slice(b, c));
          }
          function C(a, b, c) {
            ...
            for (var d = [], e = b; e < c; ) {
              ...
              null === g
                ? ((g = 65533), (h = 1))
                : g > 65535 && ((g -= 65536), d.push(((g >>> 10) & 1023) | 55296), (g = 56320 | (1023 & g))),
                d.push(g),
                (e += h);
            }
            return D(d);
          ...
          function J(a, b, c, d, e, g) {
            if (!f.isBuffer(a)) throw new TypeError('"buffer" argument must be a Buffer instance');
            if (b > e || b < g) throw new RangeError('"value" argument is out of bounds');
          ...
          function M(a, b, c, d, e) {
            return (
              ...
              Y.write(a, b, c, d, 52, 8),
              c + 8
            );
          }
          function N(a) {
            if (((a = a.trim().replace(_, '')), a.length < 2)) return '';
            for (; a.length % 4 !== 0; ) a += '=';
            return a;
          }
          function O(a) {
          ...
          var X = a('base64-js'),
            Y = a('ieee754');
          (c.Buffer = f), (c.SlowBuffer = p), (c.INSPECT_MAX_BYTES = 50);
          var Z = 2147483647;
          (c.kMaxLength = Z),
            (f.TYPED_ARRAY_SUPPORT = d()),
            ...
            (f.concat = function(a, b) {
              ...
              if (0 === a.length) return f.alloc(0);
              var c;
              if (void 0 === b) for (b = 0, c = 0; c < a.length; ++c) b += a[c].length;
              var d = f.allocUnsafe(b),
                e = 0;
              for (c = 0; c < a.length; ++c) {
                var g = a[c];
                if (!f.isBuffer(g)) throw new TypeError('"list" argument must be an Array of Buffers');
            ...
            (f.prototype.swap16 = function() {
              ...
              for (var b = 0; b < a; b += 2) s(this, b, b + 1);
              return this;
            }),
            (f.prototype.swap32 = function() {
              var a = this.length;
              if (a % 4 !== 0) throw new RangeError('Buffer size must be a multiple of 32-bits');
              for (var b = 0; b < a; b += 4) s(this, b, b + 3), s(this, b + 1, b + 2);
              return this;
            }),
            ...
            (f.prototype.toString = function() {
              var a = this.length;
              return 0 === a ? '' : 0 === arguments.length ? C(this, 0, a) : r.apply(this, arguments);
            }),
            ...
            (f.prototype.compare = function(a, b, c, d, e) {
              ...
              for (
                var g = e - d, h = c - b, i = Math.min(g, h), j = this.slice(d, e), k = a.slice(b, c), l = 0;
                l < i;
                ++l
              )
                if (j[l] !== k[l]) {
          ...
          (f.prototype.slice = function(a, b) {
            ...
            return (d.__proto__ = f.prototype), d;
          }),
            (f.prototype.readUIntLE = function(a, b, c) {
              (a >>>= 0), (b >>>= 0), c || I(a, b, this.length);
            ...
            (f.prototype.readFloatLE = function(a, b) {
              return (a >>>= 0), b || I(a, 4, this.length), Y.read(this, a, !0, 23, 4);
            }),
            (f.prototype.readFloatBE = function(a, b) {
              return (a >>>= 0), b || I(a, 4, this.length), Y.read(this, a, !1, 23, 4);
            }),
            (f.prototype.readDoubleLE = function(a, b) {
              return (a >>>= 0), b || I(a, 8, this.length), Y.read(this, a, !0, 52, 8);
            }),
            (f.prototype.readDoubleBE = function(a, b) {
              return (a >>>= 0), b || I(a, 8, this.length), Y.read(this, a, !1, 52, 8);
            }),
            ...
            (f.prototype.writeInt32LE = function(a, b, c) {
              return (
                (a = +a),
                (b >>>= 0),
                c || J(this, a, b, 4, 2147483647, -2147483648),
                (this[b] = 255 & a),
                (this[b + 1] = a >>> 8),
                (this[b + 2] = a >>> 16),
                (this[b + 3] = a >>> 24),
            ...
            (f.prototype.copy = function(a, b, c, d) {
              ...
              else if (f < 1e3) for (e = 0; e < f; ++e) a[e + b] = this[e + c];
            ...
            (f.prototype.fill = function(a, b, c, d) {
              if ('string' == typeof a) {
                ...
                if ('string' == typeof d && !f.isEncoding(d)) throw new TypeError('Unknown encoding: ' + d);
              ...
              var g;
              if ('number' == typeof a) for (g = b; g < c; ++g) this[g] = a;
              else {
            ...
            var c = (function() {
              ...
              function c(d, e, f, g, j) {
                function m(d, f) {
                  ...
                  else if (c.__isArray(d)) q = [];
                  else if (c.__isRegExp(d))
                    (q = new RegExp(d.source, h(d))), d.lastIndex && (q.lastIndex = d.lastIndex);
                  else if (c.__isDate(d)) q = new Date(d.getTime());
                  else {
                    if (p && a.isBuffer(d))
                      return (q = a.allocUnsafe ? a.allocUnsafe(d.length) : new a(d.length)), d.copy(q), q;
                    b(d, Error)
                      ? (q = Object.create(d))
                      : 'undefined' == typeof g
                      ? ((r = Object.getPrototypeOf(d)), (q = Object.create(r)))
                      : ((q = Object.create(g)), (r = g));
                  }
                  if (e) {
                    var s = n.indexOf(d);
                    if (s != -1) return o[s];
                  ...
                  for (var t in d) {
                    var u;
                    r && (u = Object.getOwnPropertyDescriptor(r, t)), (u && null == u.set) || (q[t] = m(d[t], f - 1));
                  }
                  if (Object.getOwnPropertySymbols)
                    for (var v = Object.getOwnPropertySymbols(d), t = 0; t < v.length; t++) {
                      var w = v[t],
                        x = Object.getOwnPropertyDescriptor(d, w);
                      (!x || x.enumerable || j) &&
                        ((q[w] = m(d[w], f - 1)), x.enumerable || Object.defineProperty(q, w, { enumerable: !1 }));
                    }
                  if (j)
                    for (var y = Object.getOwnPropertyNames(d), t = 0; t < y.length; t++) {
                      var z = y[t],
                        x = Object.getOwnPropertyDescriptor(d, z);
                      (x && x.enumerable) || ((q[z] = m(d[z], f - 1)), Object.defineProperty(q, z, { enumerable: !1 }));
                    }
                  return q;
                }
                'object' == typeof e &&
                  ((f = e.depth), (g = e.prototype), (j = e.includeNonEnumerable), (e = e.circular));
                var n = [],
                  o = [],
                  p = 'undefined' != typeof a;
                return 'undefined' == typeof e && (e = !0), 'undefined' == typeof f && (f = 1 / 0), m(d, f);
              }
              function d(a) {
                return Object.prototype.toString.call(a);
              }
              function e(a) {
                return 'object' == typeof a && '[object Date]' === d(a);
              }
              function f(a) {
                return 'object' == typeof a && '[object Array]' === d(a);
              }
              function g(a) {
                return 'object' == typeof a && '[object RegExp]' === d(a);
              }
              function h(a) {
                var b = '';
                return a.global && (b += 'g'), a.ignoreCase && (b += 'i'), a.multiline && (b += 'm'), b;
              }
              var i;
              try {
                i = Map;
              ...
              return (
                ...
                (c.__isArray = f),
                (c.__isRegExp = g),
                (c.__getRegExpFlags = h),
                c
              );
            })();
            'object' == typeof b && b.exports && (b.exports = c);
